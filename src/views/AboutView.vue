      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.pinimg.com/474x/00/5f/1e/005f1e2b3bb0581e0f81d3ac9293ede0.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Nelly Fananda Melani. I am a third-semester student majoring in Information Technology at Brawijaya University. I have experience in developing several web projects. Additionally, I have a background in UI/UX design. I really enjoy what I do; for me, creating programs is not just a job but an art form that has aesthetic value.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My task is to build websites that function well, are user-friendly, and remain visually appealing. I add a personal touch to each product, ensuring that the website can capture attention and is easy to use. If you are interested in collaborating with me, please feel free to contact me using the information provided.
          </p>
        </div>
