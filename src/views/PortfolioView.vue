    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          imageUrl: 'kalkulatorsederhana',
          status: 'A simple calculator with an easy-to-use interface, this tool makes it quick and easy for you to perform basic calculations. Just enter the numbers, select the operation, and click Calculate. Ideal for students and professionals seeking practical solutions for everyday calculations!',
          tech: 'html',
          github: 'null',
          demo: 'null'
        },
        {
          id: 3,
          name: 'Kalkulator BMI',
          imageUrl: 'kalkulatorbmi',
          status: 'Our BMI calculator is designed to help you understand your weight status. Calculate now for the first step towards a healthier lifestyle!',
          tech: 'JavaScript',
          github: 'https://github.com/revou-fundamental-course/8-jul-24-NellyFananda',
          demo: 'null'
        },
        {
          id: 4,
          name: 'Aplikasi Halal Palatte',
          imageUrl: 'halalpalatte',
          status: 'Halal Palatte E-Commerce Application (The Right Solution for Your Halal Culinary Needs).',
          tech: 'Figma',
          github: 'null',
          demo: 'null'
        },
        {
          id: 5,
          name: 'Aplikasi Nutri Go',
          imageUrl: 'nutrigo',
          status: 'Nutri Go Health Service Application (Nutrition Growth Oriented): Realizing a Healthy and Smart Generation Free from Stunting through Digital Application Innovation.',
          tech: 'Figma',
          github: 'null',
          demo: 'null'
        }
        ...
        <div>
          <div class="grid grid-cols-1 gap-4 pb-32 md:grid-cols-3 md:gap-3 xl:grid-cols-3 xl:gap-3 2xl:gap-5 fade-zoom-in">
            <div v-for="item in items" :key="item.id">
              <div class="item-card flex flex-col items-center gap-2 rounded-xl bg-[#1e1e1f] hover:bg-[#282828] border border-[#383838] text-amber-50 md:gap-3 px-5 py-5 lg:px-5">
                <div class="flex h-full w-full items-center justify-center p-0 zoom-in">
                  ...
                  <div class="w-full flex justify-end">
                    <div class="flex cursor-pointer items-end gap-2 text-primary">
                      ...
                      <a v-if="item.demo !== 'null'" :href="item.demo" target="_blank" rel="noreferrer" title="View finished project" class="transition-all hover:text-accent">
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
...
/* Using animation on the desired elements */
.fade-zoom-in {
