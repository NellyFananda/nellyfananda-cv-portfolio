...
.paraf {
  ...
  -webkit-line-clamp: 3; /* For WebKit-based browsers */
  line-clamp: 3; /* Standard syntax, may not be supported in all browsers */
  text-overflow: ellipsis;
  overflow: hidden;
}
@media (min-width: 768px) { 
  .paraf {
    display: -webkit-box; /* Ensures it's displayed as a box */
  }
}
